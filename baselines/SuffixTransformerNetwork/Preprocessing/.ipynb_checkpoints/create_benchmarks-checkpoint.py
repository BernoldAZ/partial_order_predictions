...
def remainTimeOrClassifBenchmark(dataset, 
    ...
    if output_type == "xes":
        ...
        # CSV output intentionally skipped: the split DataFrames are returned
        # directly to the caller and written to disk later as .pt tensors.
        # Writing large intermediate CSVs here would add significant I/O cost
        # without being consumed by any downstream pipeline step.
        pass
    else:
