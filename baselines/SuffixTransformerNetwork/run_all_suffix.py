...
Usage:
    python run_all_suffix.py                          # run 1, 1 worker (default)
    python run_all_suffix.py --workers 12             # run 1, 4 logs in parallel
    python run_all_suffix.py --run-id 2               # run 2
    python run_all_suffix.py --run-id 2 --workers 4 --progress-file /path/to/custom.log

Usage with docker:
    docker run -it --rm -v $(pwd):/app --gpus all ppm-sutran-best python3 run_all_suffix.py --workers 10
"""
