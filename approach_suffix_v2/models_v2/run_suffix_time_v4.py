...
Usage
-----
    python run_suffix_time_v4.py <log_name> [results_dir]
...
METHOD_NAME = 'gatv2_gru_stop_nb_v4'
GES_WORKERS = 4
...
def _parse_args():
    p = argparse.ArgumentParser(
        description='Train GRU+stop+new-block v4 model and evaluate for suffix + RRT')
