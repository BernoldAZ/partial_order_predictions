...
from Preprocessing.from_log_to_tensors_seq_graph import log_to_seq_graphs
...
def construct_datasets(
    ...
    train_data, val_data, test_data, counts = log_to_seq_graphs(
        log,
        log_name=log_name,
    ...
    torch.save(train_data, os.path.join(output_directory, 'train_seqgraphdataset.pt'))
    torch.save(val_data,   os.path.join(output_directory, 'val_seqgraphdataset.pt'))
    torch.save(test_data,  os.path.join(output_directory, 'test_seqgraphdataset.pt'))
